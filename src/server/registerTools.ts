...
export const PUBLIC_TOOL_DEFINITIONS: readonly PublicToolDefinition[] = [
  {
    ...
    description:
      "WhatIDO(뭐하지?) recommends Seoul activities that can be done today, prioritizing current availability, weather, discomfort index, travel distance, cost, and congestion."
  },
  {
    name: "tomorrow_what_to_do",
    title: "Tomorrow: What should I do? (내일 뭐하지?)",
    description:
      "WhatIDO(뭐하지?) recommends Seoul activities for tomorrow using the forecast, requested time of day, operating availability, travel distance, cost, reservation requirements, and congestion."
  },
  {
    name: "weekend_what_to_do",
    title: "Weekend: What should I do? (이번 주말 뭐하지?)",
    description:
      "WhatIDO(뭐하지?) recommends Seoul weekend activities by comparing Saturday and Sunday weather, prioritizing free options, and factoring in congestion, distance, and indoor Plan B suitability."
  }
];
