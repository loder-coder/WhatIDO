...
* [x] TASK-203 KMA Provider 기본 클라이언트 구현
...
* [x] TASK-208 Weather Service orchestration 구현
...
* [x] TASK-302 서울 열린데이터 Provider 구현
...
* [x] TASK-309 Event Service orchestration 구현
...
* [x] TASK-402 서울 실시간 도시데이터 Provider 구현
...
* [x] TASK-404 venue-to-area 매핑 테이블 작성
...
* [x] TASK-506 intent별 최종 점수 공식 구현
...
* [x] TASK-601 공통 Tool input schema 구현
...
* [x] TASK-602 공통 output envelope 구현
...
* [x] TASK-603 `today_what_to_do` 개발
...
* [x] TASK-604 `tomorrow_what_to_do` 개발
...
* [x] TASK-605 `weekend_what_to_do` 개발
...
* [x] TASK-606 Tool schema validation 테스트
...
* [x] TASK-607 Tool integration 테스트
...
* [x] TASK-704 Cache key builder 구현
...
* [x] TASK-707 request coalescing 구현
...
* [x] TASK-805 degraded mode builder 구현
...
* [x] TASK-806 fallback recommendation 구현
...
* [x] TASK-807 no candidates 처리 구현
...
* [x] TASK-904 Congestion unit tests
...
* [x] TASK-906 MCP Tool integration tests
...
* [x] TASK-907 Recommendation quality tests
...
* [x] TASK-908 Error handling tests
...
* [x] TASK-1004 production build 검증
...
* [x] TASK-1005 PlayMCP in KC 배포 설정 문서화
...
* [x] TASK-1006 MCP endpoint validation
...
* [x] TASK-1102 Tool description 최종 다듬기
...
* [x] TASK-1105 fallback demo plan 작성
...
* [ ] TASK-105 Health check 구현
* [x] TASK-304 문화포털 Provider 구현
* [x] TASK-306 실내/실외 추론 로직 구현 고도화
* [x] TASK-308 중복 제거 구현 고도화
* [x] TASK-404 venue-to-area 매핑 테이블 확장
* [x] TASK-407 혼잡도 edge case 테스트
* [x] TASK-509 tie-break 구현
* [x] TASK-510 다양성 제어 구현
* [x] TASK-513 ranking 품질 테스트
